      ...
      <Box sx={{ flexGrow: 1, minHeight: "100vh" }} className={classe.loginContainer}>
        <form className={classe.form} onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            <Grid size={12} sx={{ textAlign: 'center', marginBottom: '10px', fontSize: '3rem', color: '#1976d2' }}>
              <FaUserCircle />
            </Grid>
          </Grid>
          <Grid container spacing={2}>
            ...
            <Grid size={12}>
              <Button variant='contained' color='primary' fullWidth type='submit'>Se connecter</Button>
            </Grid>
          </Grid>
        </form>
      </Box>
