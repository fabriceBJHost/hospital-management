...
import {
  ...
  FormControl, Typography, Avatar, Grid, Paper, IconButton,
  Container, Card, CardContent, CardMedia, CardActionArea
} from '@mui/material';
...
const Users = () => {
  ...
  const columns = [
    { field: 'username', headerName: 'Nom d\'utilisateur', flex: 1, minWidth: 150, headerAlign: 'center', align: 'center' },
    { field: 'role', headerName: 'Rôle', flex: 1, minWidth: 150, headerAlign: 'center', align: 'center' },
    {
      field: 'images',
      headerName: 'Image',
      width: 80,
    ...
    {
      field: 'action', headerName: 'Action', flex: 1, minWidth: 150, headerAlign: 'center', align: 'center',
      renderCell: (params) => (
        <Button
          variant="contained"
          color="primary"
      ...
      <Grid container spacing={2} className={classe.HeaderGridContainer}>
        <Grid size={{ xs: 12, sm: 12, md: 6, lg: 3 }} className={classe.statGridItem}>
          <Box>
            ...
            <Grid>
              <Typography variant="h6" className={classe.title}>Statistique utilisateurs</Typography>
            </Grid>
          </Box>
        </Grid>
