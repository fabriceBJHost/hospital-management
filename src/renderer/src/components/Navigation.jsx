      ...
      <Drawer variant="permanent" color='primary' open={open} className={classe.drawer}>
        <DrawerHeader className={classe.drawerHeader}>
          ...
          <IconButton onClick={handleDrawerClose}>
            {theme.direction === 'rtl' ? <FaChevronRight className={classe.icon} /> : <FaChevronLeft className={classe.icon} />}
          </IconButton>
        </DrawerHeader>
        ...
        <List className={classe.drawer}>
          ...
          <Link className={classe.menu} to={'/'}>
            <ListItem disablePadding className={location.pathname == '/' && classe.menuActive} sx={{ display: 'block' }}>
              <ListItemButton className={`${classe.ListItemButton} ${open ? classe.open : classe.closed}`}>
                <ListItemIcon className={open ? classe.iconOpen : classe.iconClosed}>
                  <MdDashboard className={location.pathname == '/' ? classe.iconActive : classe.icon} />
                </ListItemIcon>
                <ListItemText primary={"Tableau de bord"} className={open ? classe.textVisible : classe.textHidden} />
              </ListItemButton>
            </ListItem>
          </Link>
          ...
          <Link className={classe.menu} to={'/users'}>
            <ListItem disablePadding className={location.pathname == "/users" && classe.menuActive} sx={{ display: 'block' }}>
              <ListItemButton className={`${classe.ListItemButton} ${open ? classe.open : classe.closed}`}>
                <ListItemIcon className={open ? classe.iconOpen : classe.iconClosed}>
                  <FaUsers className={location.pathname == '/users' ? classe.iconActive : classe.icon} />
                </ListItemIcon>
                <ListItemText primary={"Utilisateurs"} className={open ? classe.textVisible : classe.textHidden} />
              </ListItemButton>
            </ListItem>
          </Link>
          ...
          <Link className={classe.menu} to={'/patients'}>
            <ListItem disablePadding className={location.pathname == '/patients' && classe.menuActive} sx={{ display: 'block' }}>
              <ListItemButton className={`${classe.ListItemButton} ${open ? classe.open : classe.closed}`}>
                <ListItemIcon className={open ? classe.iconOpen : classe.iconClosed}>
                  <FaUserInjured className={location.pathname == '/patients' ? classe.iconActive : classe.icon} />
                </ListItemIcon>
                <ListItemText primary={"Patients"} className={open ? classe.textVisible : classe.textHidden} />
              </ListItemButton>
            </ListItem>
          </Link>
          ...
          <Link className={classe.menu} to={'/doctor'}>
            <ListItem disablePadding className={location.pathname == '/doctor' && classe.menuActive} sx={{ display: 'block' }}>
              <ListItemButton className={`${classe.ListItemButton} ${open ? classe.open : classe.closed}`}>
                <ListItemIcon className={open ? classe.iconOpen : classe.iconClosed}>
                  <FaUserMd className={location.pathname == '/doctor' ? classe.iconActive : classe.icon} />
                </ListItemIcon>
                <ListItemText primary={"Docteurs"} className={open ? classe.textVisible : classe.textHidden} />
              </ListItemButton>
            </ListItem>
          </Link>
          ...
          <Link className={classe.menu} to={'/appointment'}>
            <ListItem disablePadding className={location.pathname == '/appointment' && classe.menuActive} sx={{ display: 'block' }}>
              <ListItemButton className={`${classe.ListItemButton} ${open ? classe.open : classe.closed}`}>
                <ListItemIcon className={open ? classe.iconOpen : classe.iconClosed}>
                  <FaLocationDot className={location.pathname == '/appointment' ? classe.iconActive : classe.icon} />
                </ListItemIcon>
                <ListItemText primary={"Rendez vous"} className={open ? classe.textVisible : classe.textHidden} />
              </ListItemButton>
            </ListItem>
          </Link>
          ...
          <Link className={classe.menu} to={'/medicalrecord'}>
            <ListItem disablePadding className={location.pathname == '/medicalrecord' && classe.menuActive} sx={{ display: 'block' }}>
              <ListItemButton className={`${classe.ListItemButton} ${open ? classe.open : classe.closed}`}>
                <ListItemIcon className={open ? classe.iconOpen : classe.iconClosed}>
                  <FaFileAlt className={location.pathname == '/medicalrecord' ? classe.iconActive : classe.icon} />
                </ListItemIcon>
                <ListItemText primary={"Dossier médical"} className={open ? classe.textVisible : classe.textHidden} />
              </ListItemButton>
            </ListItem>
          </Link>
          ...
          <Link className={classe.menu} to={'/prescription'}>
            <ListItem disablePadding className={location.pathname == '/prescription' && classe.menuActive} sx={{ display: 'block' }}>
              <ListItemButton className={`${classe.ListItemButton} ${open ? classe.open : classe.closed}`}>
                <ListItemIcon className={open ? classe.iconOpen : classe.iconClosed}>
                  <FaNotesMedical className={location.pathname == '/prescription' ? classe.iconActive : classe.icon} />
                </ListItemIcon>
                <ListItemText primary={"Prescription médical"} className={open ? classe.textVisible : classe.textHidden} />
              </ListItemButton>
            </ListItem>
          </Link>
        </List>
        ...
        <List className={classe.drawer}>
          ...
          <Link className={classe.menu} to={'/setting'}>
            <ListItem disablePadding className={location.pathname == '/setting' && classe.menuActive} sx={{ display: 'block' }}>
              <ListItemButton className={`${classe.ListItemButton} ${open ? classe.open : classe.closed}`}>
                <ListItemIcon className={open ? classe.iconOpen : classe.iconClosed}>
                  <FaCog className={location.pathname == '/setting' ? classe.iconActive : classe.icon} />
                </ListItemIcon>
                <ListItemText primary={"Parametre"} className={open ? classe.textVisible : classe.textHidden} />
              </ListItemButton>
            </ListItem>
          </Link>
          ...
          <ListItem disablePadding sx={{ display: 'block' }}>
            <ListItemButton className={`${classe.ListItemButton} ${open ? classe.open : classe.closed}`}>
              ...
              <ListItemText primary={"Déconnection"} className={open ? classe.textVisible : classe.textHidden} />
            </ListItemButton>
          </ListItem>
        </List>
      </Drawer>
